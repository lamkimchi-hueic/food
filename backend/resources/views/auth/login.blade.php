...
<head>
    ...
    <title>MIX CURRY HOUSE - Login</title>
...
<body class="bg-[#0F0F11] text-white antialiased font-sans flex flex-col min-h-screen">
    ...
    <nav class="flex items-center justify-between px-10 py-8 max-w-7xl mx-auto w-full">
        ...
        <div class="flex items-center space-x-6">
            <a href="/register" class="text-sm font-bold text-gray-300 hover:text-[#FF6600] transition">Register</a>
        </div>
    </nav>
    ...
    <main class="flex-grow flex items-center justify-center px-6">
        <div class="w-full max-w-md bg-[#1A1A1E] rounded-[2rem] p-10 border border-gray-800/50 shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-gray-400 text-sm mb-8">Please enter your credentials to login.</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="username" id="username" value="{{ old('username') }}" required autofocus class="w-full bg-[#0F0F11] border border-gray-800 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-[#FF6600] focus:ring-1 focus:ring-[#FF6600] transition text-sm">
                    </div>
                ...
                <div class="mt-8 text-center text-sm text-gray-400">
                    ...
                    <a href="{{ route('register') }}" class="text-[#FF6600] font-semibold hover:underline">Register here</a>
                </div>
            </div>
        </div>
    </main>
