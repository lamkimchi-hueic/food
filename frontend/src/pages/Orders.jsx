...
export default function Orders() {
    ...
    const getStatusLabel = (status) => {
        switch(status) {
            case 0: return { text: 'Pending', class: 'bg-yellow-500/10 text-yellow-500' };
            case 1: return { text: 'Processing', class: 'bg-blue-500/10 text-blue-500' };
            case 2: return { text: 'Completed', class: 'bg-green-500/10 text-green-500' };
            case 3: return { text: 'Cancelled', class: 'bg-red-500/10 text-red-500' };
            default: return { text: 'Unknown', class: 'bg-gray-500/10 text-gray-500' };
        }
    };
            ...
            <main className="flex-grow max-w-7xl mx-auto px-10 py-16 w-full">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-12">
                    <div>
                        ...
                        <p className="text-gray-400">Track and manage your recent dining experiences.</p>
                    </div>
                    <Link to="/menu" className="mt-6 md:mt-0 px-8 py-3 bg-gray-800 text-white font-bold rounded-full hover:bg-[#FF6600] hover:text-black transition">New Order</Link>
                </div>
                ...
                {fetching ? (
                    ...
                    <div className="text-center py-20 bg-[#1A1A1E] rounded-[3rem] border border-gray-800">
                        ...
                        <Link to="/menu" className="px-10 py-4 bg-[#FF6600] text-black font-black rounded-full hover:bg-orange-600 transition uppercase tracking-widest text-sm">Browse Menu</Link>
                    </div>
                ) : (
                            ...
                            return (
                                <div key={order.id} className="bg-[#1A1A1E] rounded-[2.5rem] overflow-hidden border border-gray-800 hover:border-[#FF6600]/30 transition duration-500 shadow-2xl">
                                    <div className="p-8 md:p-10">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
                                            <div className="flex items-center space-x-6">
                                                ...
                                                <div>
                                                    <div className="text-xs text-gray-500 font-black uppercase tracking-widest mb-1">Order ID #{order.id}</div>
                                            ...
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div className="text-right">
                                                    <div className="text-xs text-gray-500 font-black uppercase tracking-widest mb-1">Total Amount</div>
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                            <div className="space-y-4">
                                                <h4 className="text-xs text-gray-500 font-black uppercase tracking-widest mb-4">Items Ordered</h4>
                                                {order.order_items?.map((item, idx) => (
                                                    <div key={idx} className="flex items-center space-x-4 bg-[#141416] p-4 rounded-2xl border border-gray-800/50">
                                                        ...
                                                        <div className="flex-grow">
                                                            ...
                                                            <div className="text-gray-500 text-xs">Qty: {item.amount} &bull; ${parseFloat(item.product?.price || 0).toFixed(2)} ea</div>
                                                        </div>
                                            ...
                                            <div className="bg-[#141416] p-8 rounded-3xl border border-gray-800/50 relative overflow-hidden group">
                                                ...
                                                <h4 className="text-xs text-gray-500 font-black uppercase tracking-widest mb-6">Delivery Details</h4>
                                                <div className="space-y-6">
                                                    <div className="flex items-start space-x-4">
                                                        ...
                                                        <div>
                                                            <div className="text-[10px] text-gray-600 font-black uppercase tracking-[0.2em] mb-1">Receiver</div>
                                                    ...
                                                    <div className="flex items-start space-x-4">
                                                        ...
                                                        <div>
                                                            <div className="text-[10px] text-gray-600 font-black uppercase tracking-[0.2em] mb-1">Phone</div>
                                                    ...
                                                    <div className="flex items-start space-x-4">
                                                        ...
                                                        <div>
                                                            <div className="text-[10px] text-gray-600 font-black uppercase tracking-[0.2em] mb-1">Address</div>
                                    ...
                                    <div className="bg-[#1A1A1E] border-t border-gray-800 px-10 py-5 flex justify-between items-center">
                                        <div className="text-[10px] text-gray-600 font-black uppercase tracking-[0.2em]">Thank you for dining with us</div>
                                        <button onClick={() => window.print()} className="text-[#FF6600] text-xs font-black uppercase tracking-widest hover:underline transition">Print Receipt</button>
                                    </div>
                                </div>
                            );
                        })}
