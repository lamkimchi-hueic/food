                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start mt-4">
                    <div className="w-full h-[500px] bg-[#1A1A1E] rounded-3xl overflow-hidden border border-gray-800 shadow-2xl relative">
                        ...
                        <div className="absolute top-6 left-6 bg-[#FF6600] text-black font-bold px-4 py-2 rounded-full text-sm">
                            {product.category?.name || 'Đặc biệt'}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-12 bg-[#141416] p-6 rounded-2xl border border-gray-800">
                            <h3 className="font-bold text-lg mb-4">Thông tin dinh dưỡng</h3>
                            <div className="space-y-3 text-sm text-gray-400">
                                <div className="flex justify-between border-b border-gray-800 pb-2"><span>Calo</span><span className="text-white">450 kcal</span></div>
                                ...
                                <div className="flex justify-between border-b border-gray-800 pb-2"><span>Đạm</span><span className="text-white">25g</span></div>
                                <div className="flex justify-between"><span>Chất béo</span><span className="text-white">18g</span></div>
                            </div>
                        </div>
                    </div>
                </div>
